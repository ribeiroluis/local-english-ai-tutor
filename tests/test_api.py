...
def test_converse_endpoint_returns_json(client):
    ...
    with patch("app.services.stt.transcribe") as mock_stt:
        mock_stt.return_value = {"text": "Hello", "confidence": 0.9, "duration_sec": 0.1}
        with patch("app.services.llm._ollama_chat") as mock_llm:
            mock_llm.return_value = '{"reply": "Hi there!", "correction": null}'
